...
namespace Assignment
{
    public class Lecture : MonoBehaviour
    {
        ...
        public void LCT02_SyntaxLinkedList()
        {
            ...
            linkedlist.AddFirst("Node 0"); //First จะมาก่อน Last

            LinkedListNode<string> firstNode = linkedlist.First;
            Debug.Log("first : " + firstNode.Value);

            LinkedListNode<string> lastNode = linkedlist.Last;
            Debug.Log("lost : " + lastNode.Value);
            ...
            if (firstNode.Previous == null) Debug.Log("firstNode.Previous == nill");
            ...
            linkedlist.Remove("Node 1"); //ค้นหา Node 1
            linkedlist.Remove(node1); //ลบตัว Node 1 เลย
            linkedlist.RemoveLast();
            linkedlist.RemoveFirst();

            linkedlist.Clear(); //ลบทั้งหมดในตัวแปรที่กำหนด
        }
        ...
        public void LCT04_SyntaxDictionary()
        {
            ...
            inv.Add("Potion", 1); //เพิ่มยา 1

            inv.Add("Apple", 10); //เพิ่ม Apple 10

            inv["Banana"] = 5; //ได้เหมือนกัน
            ...
            var ketExists = inv.ContainsKey("Key");
            Debug.Log(ketExists);
